 ...
 * jquery.paginator
 *
 * Copyright (c) 2014 moises.rangel@gmail.com
 *
 * Licensed under MIT
...
(function ($) {
    $.fn.paginator = function (options) {
        ...
        var tableheader = (typeof options.tableheader == 'undefined') ? false : options.tableheader;
        ...
        var buildNavigation = function () {
            ...
            if (pageItemsContainer.length > 0) {
                ...
                if(Math.round(totalpages) < iteration_pages)
                {
                    iteration_pages = Math.round(totalpages);
                }
        ...
        var showHeader = function () {
            if (tableheader) {
                itemCollection.first().show();
            }
        }

        var HasTR = function (item) {
            var value = true;
